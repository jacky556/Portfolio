...
const About = () => {
    ...
    const featuresData = [
        ...
        },
        {
            ...
            <p><span className= "gradient__text">HTML, CSS, Javascript(React.js, Cloud FireStore, Axios),SQL(MySQL Local Host), C#(Unity with Firebase Realtime Database).</span></p>
